...
public class ClassicLaptop extends Laptop {
    public ClassicLaptop(Integer ramSize, String memoryType, Integer memorySize, Integer screenSize, String osType, String bodyMaterial, String color) {
        super(ramSize, memoryType, memorySize, screenSize, osType, bodyMaterial, color);
    }

    public ClassicLaptop() {
    }
    ...
    public Laptop createRandomLaptop() {
        ...
        return new ClassicLaptop(ramSize, memoryType, memorySize, screenSize, osType, bodyMaterial, color);
    }
