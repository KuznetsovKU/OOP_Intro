...
public class Ultrabook extends Laptop {
    public Ultrabook(Integer ramSize, String memoryType, Integer memorySize, Integer screenSize, String osType, String bodyMaterial, String color) {
    ...
    public Laptop createRandomLaptop() {
        ...
        return new Ultrabook(ramSize, memoryType, memorySize, screenSize, osType, bodyMaterial, color);
    }
